...
import 'package:schools_management/widgets/parent/discipline_tile.dart';
//import 'package:schools_management/widgets/parent/task_tile.dart';

class displine extends StatefulWidget {
  final String studentId;

  displine({this.studentId});
  @override
  _displineState createState() => _displineState();
}

class _displineState extends State<displine> {
  var activities;

  @override
  void initState() {
    activities = GetHelper.getData(widget.studentId, 'get_student_discipline',
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context, snapshots) {
                      if (!snapshots.hasData || snapshots.data.length == 0) {
                        return Center(
                            child: Text('No Disciplinary activities Right now',
